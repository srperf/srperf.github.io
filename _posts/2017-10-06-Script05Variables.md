...
![Variables scripting](/assets/img/BackupMedia/2017/10/ArtBoard-Image-35.jpg)
...
![Variables actors](/assets/img/BackupMedia/2017/10/Actors.png)This is just like assigning actors to the characters on a theater play. You have the role of Romeo on the play as the main role. You must look for the actor and assign mister Rad Peet to the main role. Then you will go to Juliet. You will assign the role to Meagan Fatz. Follow this until you have all the characters assigned to an actor. After that you will deal with roles, rather than actors.
...
![Special variable](/assets/img/BackupMedia/2017/10/Special.png)
